            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @php
                        ...
                        $method = 'get';
                        if ($crud == 'edit') {
                            $action = route('clientes.update', $data->id);
                            $method = 'patch';
                        }
                        if ($crud == 'create') {
                    ...
                    <form method="post" action="{{ $action }}" class="mt-6 space-y-6">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-3">
                                <x-checkbox-input :value="old('inativo', $data->inativo)" :canEdit="$disabled">Inativo</x-checkbox-input>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-4">
                                <x-input-label for="fone1" :value="'Fone #1'" />
                                <x-text-input id="fone1" name="fone1" type="text" class="mt-1 block w-full"
                                    :value="old('fone1', $data->fone1)" autocomplete="fone1" :canEdit="$disabled" />
                                <x-input-error class="mt-2" :messages="$errors->get('fone1')" />
                            </div>
                            <div class="col-4">
                                <x-input-label for="fone2" :value="'Fone #2'" />
                                <x-text-input id="fone2" name="fone2" type="text" class="mt-1 block w-full"
                                    :value="old('fone2', $data->fone2)" autocomplete="fone2" :canEdit="$disabled" />
                                <x-input-error class="mt-2" :messages="$errors->get('fone2')" />
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-4">
                                <x-input-label for="tabela0" :value="'Tabela (Expresso)'" />
                                <x-text-input id="tabela0" name="tabela0" type="text" class="mt-1 block w-full"
                                    :value="old('tabela0', $data->tabela0)" autocomplete="tabela0" :canEdit="$disabled" />
                                <x-input-error class="mt-2" :messages="$errors->get('tabela0')" />
                            </div>
                            <div class="col-4">
                                <x-input-label for="tabela1" :value="'Tabela (Premium)'" />
                                <x-text-input id="tabela1" name="tabela1" type="text" class="mt-1 block w-full"
                                    :value="old('tabela1', $data->tabela1)" autocomplete="tabela1" :canEdit="$disabled" />
                                <x-input-error class="mt-2" :messages="$errors->get('tabela1')" />
                            </div>
                        </div>
